...
<body>
    ...
    <script>
        function respond() {
            let userInput = document.getElementById("recipe").value.toLowerCase();

            let answer = "";
            let instructions = "";

            if (userInput.includes("cookie")) {
                answer = "To make cookies, you will need flour, sugar, butter, and chocolate chips.\n Baking tip: Chill the dough for 30 minutes before baking for thicker cookies.";
            ...
            else if (userInput.includes("cake")) {
                answer = "To make a cake, you will need flour, sugar, eggs, butter, and baking powder.\n Baking tip: Chill the cake before frosting.";
            ...
            else if (userInput.includes("bread")) {
                answer = "To make bread, you will need flour, yeast, water, and salt.\n Baking tip: Let the dough rise in a warm place for the best texture.";
            ...
            else if (userInput.includes("brownie")) {
                answer = "To make brownie, you will need cocoa powder, oil, eggs, water, vanilla extract and powdered sugar.\n Baking tip: Do not overbake because brownies should still be slightly soft in the center.";
            ...
            else if (userInput.includes("pie")) {
                answer = "To make a pie, you will need a pie crust and your favorite filling. Eggs, water, sugar, and vanilla extract.\n Baking tip: Chill the pie crust before baking to help it stay flaky.";
            ...
            else if (userInput.includes("gluten-free") || userInput.includes("gluten free")) {
                answer = "To make a gluten-free fudge cake, you will need eggs, cocoa powder, sugar, oil, water, and vanilla extract.\n Baking tip: Let the cake cool before cutting so it holds its shape better.";
                ...
                answer = "I can help with cookies, cakes, bread, brownies, pies, and gluten-free fudge cake.";
